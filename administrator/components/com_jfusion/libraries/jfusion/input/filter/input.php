...
{
	/**
	 * A container for Filter_Input instances.
	 *
	 * @var    array
	 * @since  11.3
	 */
	 ...
	 * @param   integer  $xssAuto     Only auto clean essentials = 0, Allow clean blacklisted tags/attr = 1
	 *
	 * @return  Filter_Input  The JFilterInput object.
	 *
	 * @since   11.1
	 */
	public static function &getInstance($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1)
	{
		...
		{
			self::$instances[$sig] = new Filter_Input($tagsArray, $attrArray, $tagsMethod, $attrMethod, $xssAuto);
		}
