<?php namespace JFusion\Language;
/**
...
class Text
{
	 ...
	 *
	 * Examples:
	 * <?php echo Text::alt("JALL","language");?> it will generate a 'All' string in English but a "Toutes" string in French
	 * <?php echo Text::alt("JALL","module");?> it will generate a 'All' string in English but a "Tous" string in French
	 *
	 * @param   string   $string                The string to translate.
	 ...
	 * <?php echo Text::plural("COM_PLUGINS_N_ITEMS_UNPUBLISHED", 1);?> it will generate a '1 plugin successfully disabled' string
	 *
