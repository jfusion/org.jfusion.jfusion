...
abstract class String
{
	...
	public static function splitCamelCase($string)
	{
		...
		return StringNormalise::fromCamelCase($string, true);
	}
	 ...
	 * @param bool|int $offset Optional, specifies the position from which the search should be performed
	 *
	 ...
	 * @param bool|int  $length Optional length in UTF-8 characters from offset
	 *
	 ...
	 * @param bool|string $charlist The optional charlist of additional characters to trim
	 *
