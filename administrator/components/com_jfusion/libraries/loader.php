...
defined('JFUSIONPATH_PLATFORM') or die;
...
abstract class JFusionLoader
{
	...
	public static function setup($enablePsr = true, $enablePrefixes = true, $enableClasses = true)
	{
		if ($enableClasses)
		{
			...
			spl_autoload_register(array('JFusionLoader', 'load'));
		}
		...
		if ($enablePrefixes)
		{
			...
			spl_autoload_register(array('JFusionLoader', '_autoload'));
		}

		if ($enablePsr)
		{
			// Register the PSR-0 based autoloader.
			spl_autoload_register(array('JFusionLoader', 'loadByPsr0'));
			spl_autoload_register(array('JFusionLoader', 'loadByAlias'));
		}
	}
