        ...
        <table class="adminlist" style="border-spacing:1px;">
            ...
            <?php foreach ($this->slave_data as $slave) { ?>
                <tr>
                    ...
                    <td>
                        <?php echo JText::_('SLAVE') ?></td>
                    <td>
                        <?php echo $slave['total']; ?></td>
                    <td>
                        <select name="slave[<?php echo $slave['jname']; ?>][perform_sync]">
...
<?php } else { ?>
    <h2>
        <?php echo JText::sprintf('SYNC_RESUME_SYNC', $this->syncid) ?>
    </h2>
...
<div id="ajax_bar">
    <b>
        <?php echo JText::_('SYNC_CONTROLLER'); ?>
    </b>
    &nbsp;&nbsp;&nbsp;
    <a id="start" href="#">
