...
class doku_auth_basic
{
        ...
        switch ($cap) {
            ...
            default:
                ...
                if (!isset($this->cando[$cap])) {
                    JFusionFunction::raiseWarning("Check for unknown capability '$cap' - Do you use an outdated Plugin?", $this->helper->getJname());
                    return false;
                }
    ...
    {
        JFusionFunction::raiseWarning('no valid authorisation system in use', $this->helper->getJname());
        return false;
    }
    ...
    {
        if (!$this->cando['external']) JFusionFunction::raiseWarning('no valid authorisation system in use', $this->helper->getJname());
        return false;
    }
    ...
    {
        JFusionFunction::raiseWarning('authorisation method does not allow creation of new users', $this->helper->getJname());
        return null;
    }
    ...
    {
        JFusionFunction::raiseWarning('authorisation method does not allow modifying of user data', $this->helper->getJname());
        return false;
    }
    ...
    {
        JFusionFunction::raiseWarning('authorisation method does not allow deleting of users', $this->helper->getJname());
        return false;
    }
    ...
    {
        JFusionFunction::raiseWarning('authorisation method does not provide user counts', $this->helper->getJname());
        return 0;
    }
    ...
    {
        JFusionFunction::raiseWarning('authorisation method does not support independent group creation', $this->helper->getJname());
        return false;
    }
    ...
    {
        JFusionFunction::raiseWarning('authorisation method does not support group list retrieval', $this->helper->getJname());
        return array();
    }
