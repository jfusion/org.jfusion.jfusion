 ...
 */
if (!class_exists('JFusion_Horde_Cipher_blowfish')) {
	// Change for phpMyAdmin by lem9:
	//class JFusion_Horde_Cipher_blowfish extends Horde_Cipher {
	/**
	 * Class JFusion_Horde_Cipher_blowfish
	 */
	class JFusion_Horde_Cipher_blowfish
	{
	    /* Pi Array */
	 ...
	 * @author  lem9
	 */
	function JFusion_PMA_blowfish_encrypt($data, $secret)
	{
	 ...
	 * @author  lem9
	 */
	function JFusion_PMA_blowfish_decrypt($encdata, $secret)
	{
	    $pma_cipher = new JFusion_Horde_Cipher_blowfish;
	    $decrypt = '';
