...
class JFusionPublic_dokuwiki extends JFusionPublic {
    ...
    function getBuffer(&$data) {
        ...
        if (!is_file($index_file)) {
            JFusionFunction::raiseWarning('The path to the DokuWiki index file set in the component preferences does not exist');
        } else {
            ...
            if (!$rs) {
                JFusionFunction::raiseWarning('Could not find DokuWiki in the specified directory');
            }
        }
    }
