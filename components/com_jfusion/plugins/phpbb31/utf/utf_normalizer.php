...
class utf_normalizer_phpbb {
    ...
    function cleanup(&$str) {
        ...
        if (!isset($GLOBALS['utf_nfc_qc'])) {
            require_once JFUSION_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'phpbb31' . DIRECTORY_SEPARATOR . 'utf' . DIRECTORY_SEPARATOR . 'utf_nfc_qc.php';
        }
        if (!isset($GLOBALS['utf_canonical_decomp'])) {
            require_once JFUSION_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'phpbb31' . DIRECTORY_SEPARATOR . 'utf' . DIRECTORY_SEPARATOR . 'utf_canonical_decomp.php';
        }
    ...
    public static function nfkc(&$str) {
        ...
        if (!isset($GLOBALS['utf_compatibility_decomp'])) {
            require_once JFUSION_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'phpbb31' . DIRECTORY_SEPARATOR . 'utf' . DIRECTORY_SEPARATOR . 'utf_compatibility_decomp.php';
        }
    ...
    function recompose($str, $pos, $len, &$qc, &$decomp_map) {
        ...
        if (!isset($utf_jamo_index, $utf_jamo_type, $utf_combining_class)) {
            require_once JFUSION_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'phpbb31' . DIRECTORY_SEPARATOR . 'utf' . DIRECTORY_SEPARATOR . 'utf_normalizer_common.php';
        }
        // Load the canonical composition table
        if (!isset($utf_canonical_comp)) {
            require_once JFUSION_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'phpbb31' . DIRECTORY_SEPARATOR . 'utf' . DIRECTORY_SEPARATOR . 'utf_canonical_comp.php';
        }
