...
<div class='jfusionUserAvatar'><img style='max-height: <?php echo $p->avatar_height; ?>px; max-width: <?php echo $p->avatar_width; ?>px;' src='<?php echo $p->avatar_src; ?>'></div>
<?php endif; ?>

<span class = 'jfusionPostTitle'><a href="<?php echo $p->subject_url; ?>"><?php echo $p->subject; ?></a></span>
